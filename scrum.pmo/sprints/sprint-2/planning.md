...
| [task-s2-i](./task-s2-i-shell-reaper.md) | shell.reap — reap accumulated bg shells (fd-leak/persist-thru-rewind) | HIGH (Tron/SM) | ✅ **IMPL DONE (64c0365) safe-by-construction (allow-list, default-KEEP, kill-by-PID) — awaiting tester T-SHELL-REAP; rewind auto-trigger deferred until green** |
