...
| [task-s2-c](./task-s2-c-registry-route-identity.md) | registry / route / identity integrity | CRITICAL/HIGH | C.0 live-reader (DRY foundation) → architect designing; C.1 SHIPPED; C.2+C.3 DESIGNS done; T-RECONCILE-FORK red ✅ → expert impl awaits rewind |
