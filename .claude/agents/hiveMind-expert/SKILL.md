...
Discover your own identity in the tmux environment. Both change on restart/rewind — must re-discover every time.
...
After a rewind: 1) State identity 2) Read this SKILL.md 3) Read context.md 4) Read backlog.md + TaskCreate 5) Read learnings.md 6) Read `/Users/donges/oosh/hiveMind`
