...
- Expert (fixes + commits + state reached): **IN PROGRESS.**
  ...
  - **VERIFY re-install IN PROGRESS** (single cycle per new tactic) — checking chain reaches 62 + root `.bashrc` wired. Total commits: BUG5 2b68265, d546947, 044dc75, edbbabc, 376020e, batch ffb38c9 (+5 gate install-transport).
