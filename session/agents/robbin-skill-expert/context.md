...
**STANDING TRIGGER (unchanged):** freeze lifts -> R40.17 explicit-current built to my settled precedence (3e789db9e + 6864cdca8) is my first item. QA-Review is NOT terminal (only Tron approve->Done or explicit-current resolves the ambiguity).
