...
- R27.8 drawer fix (X-closes / first-open-minimized / grab-bar-expands): NOT SHIPPED — Impl closeAndMinimize e42b85e8 open-expert, drawer code still X->minimize (v0.6.94). Standing by to gate on ship via r255 drawer harness (#room-file-preview + .drawer-close/.drawer-handle/[minimized]) + ESC + pan-zoom.
