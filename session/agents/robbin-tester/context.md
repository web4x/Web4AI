...
- v0.6.92 email-drop fixes (gate ab3a84c2f): (1)UTF-8 + (2)WebItem-primary/.eml-child GREEN DET-3x. (3)no-raw-uuid BLOCKED by MY in-memory pollution (drop+delete -> dangling refs 93fda25d/10f174e3/0c5e6972/01bf3c49 + a695106e resurrect; server re-persists in-memory, disk-clean undone). REQUESTED server RESTART; re-gate (3) after. NEVER delete dropped units.
