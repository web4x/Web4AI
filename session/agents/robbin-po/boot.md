...
### ★★ TWO THINGS OPEN WITH TRON — ASK ONCE, DO NOT NAG
...
2. **PUSH BLOCKED**: `ed6b77891` + `25d3d2c69` (Layer-1 rbadd + staged-subset hook) are LOCAL-ONLY — expert AND architect both hit the auto-mode classifier and correctly did NOT work around it. Needs Tron to push or authorize. Not operationally risky (hook live in the tree) but 3 of today's 9 lying labels aimed at exactly these files.
