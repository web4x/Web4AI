...
### ★★★ R30.35 MINTED (req 48dda0612, UUID 96634144, SPRINT30=40) — DIFF COLORING SEMANTICS + MERGE ACTIONS (Tron, scenario-first). 2 UCs: merge.kindColoring 9c41a415→computeMergedCenter a0b30550 + merge.blockActions d7493e80→acceptChange 843d79d4. 7 ACs. Architect designs AFTER R30.14. crossRef R30.9+R30.16+R30.28. Chain: req✓ → architect → expert → screenshot gate.
