...
- FIX DRIVING: expert (0.1) = ROW is the reliable DEFAULT, stack only below TRUE phone width (~600), keyed on VIEWPORT; verify+screenshot at 1920/1440/1280/1024 (all columns) + 390 (stack). tester (0.5) = root-cause current stack-transition px + width-range re-gate. Version-bump+atomic.
