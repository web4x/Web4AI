...
- NEXT (tester re-measuring, non-blocking): T30.29 mod-region-resync was RED @v0.7.42; re-measure on current v0.7.47 (past R30.30 v0.7.43 strict-0px fix) to disambiguate SAME-as-R30.30 vs DISTINCT-still-open. Measurement decides, not a guess. BUG-2 (Tron LEFT-empty R30.25) parked pending Tron's repro steps.
