...
- ★★★ TRON APPROVED 'implement them all' (2026-07-18) → PO issued build-gos (me, NOT the SM):
  ...
  - 🔨 EXPERT building R30.35 data-model replacement (pick→included-line-SET, addSide for >>/<<, NEW removeLine, both-versions center dark/highlight) THEN R30.36 nav-aids (brighter-current + openChangeCount). TESTER gating each. → gate → deploy → Tron.
