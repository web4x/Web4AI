...
- REMAINING S30 after T30.27 closes: R30.34 (awaits Tron visual sign-off → close + unhold R30.31) + T30.9 QA-Review (Tron-accepted, last-3 hops). Board otherwise 0-open.
