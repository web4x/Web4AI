...
- ★★ NAMING VIOLATION (Tron caught, my review miss): 12 core merge-action UCs were snake_case (add_takeLocal…) vs camelCase convention. REQ renaming NAME-only (uuids unchanged, dual-links safe) → addTakeLocal etc + regen requirements.md/trace/SVG + ADD a camelCase validator (correct-by-construction, reject snake_case at mint). Edges already camelCase. IMPLEMENT still gated on Tron Q1/Q2.
