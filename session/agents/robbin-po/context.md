...
- ★ NOW: expert PLACES Impl marker 769bc9bc (req minted it 3e2e0e868 while expert built — its 'TBD-REQ-MINT' was stale) + builds R30.35. TESTER independent DET gate (r3014 harness, real left-open, anti-circular close). 
