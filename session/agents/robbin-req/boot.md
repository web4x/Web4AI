...
| R31.4 pane→xterm.js terminal | fb14fdbf | paneTerminal.attach fa1845d3 | PtyBridge 59648f26 | attachPane 6fc43b8e | — | — | 9 ACs — B1 ticket-at-upgrade / B2 node-pty / B3 no-disrupt / **FULL-INTERACTIVE by default (Tron 42e223d1c REVERSED B4 read-only-default; AC-readonly-default+AC-take-control DROPPED, AC-full-interactive added)**. Impl pending expert |
