...
> **ANCHOR (2026-07-14, compacted from oversized blob): Sprint 30, 25 reqs, all on disk + visible in requirements.md.** The R30.9→R30.16 IntelliJ diff/merge-editor arc is CLOSED + 17/17 genuinely behavior-tested on origin/main (one canonical Class RbDiffEditor 18165081, 9→25 methods, R27.2 invariant held). Recent: R30.17 (merge functional fixes) built + retired-clean; R30.18 (requirements.md=generated-view) + R30.11 (scorer honors impl-level supersededBy @skill-classes.ts:193) await EXPERT BUILDS; R30.19 (3-pane change blocks, NEW renderSideChangeBlocks ef5a4ff2 [MARKER=eb994dcd]) awaits architect derive-confirm. Scoreboard: R30.10 + R30.6.1/6.3 = the impl-level-supersede class, EXPECTED-until-R30.11-builds (pre-existing, honest, not a new gap).
