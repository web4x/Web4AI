...
S8(20 UC), S9(6 UC), S11(1), S13(7), S16(4), S17(29 R17.1-R17.29 + R-I split R17.30-R17.47)
...
- R-E: Chain ORDER req-task-uc-class-method-impl-test(s) [1:N] -- 2be6e96 + 7e01491
- R-F: Data quality complete tree zero back-chaos zero untraced -- 2be6e96
- R-G: Diligent plan no-stop SM re-activated -- 2be6e96
- R-H: Massive orphans + wrong direction + missing data fill (JOINT) -- b88771c
- R-I: Tasks split into atomic one-sentence requirements (STANDING RULE) -- 4d600a7
- R-J: Every Test reachable via tracking chain -- 4d600a7
- R-K1/K2/K3: .scenario.json click to /trace tree + lazy-load -- 4039763
- R-L: Generated views never emit dead links (+refinements) -- c208757 + f4945fa + eea96cb
- R-M1: Desktop drawer no placeholder -- acae0ffe
- R-M2: Desktop drawer no swipe-handle -- acae0ffe
- R-M3: NEW /scenario?ior= route -- acae0ffe
  - R-M3a: Honor ior param -- d112b865
  - R-M3b: Minimum scroll+open -- d112b865
  - R-M3c: Sprint ONLY item+lazy-load (!!!) -- d112b865
