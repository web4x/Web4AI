...
- Rewind target: look for "you have been rewound...read your context files" or boot prompt as natural checkpoint — NOT arbitrary 10 steps. After rewind, clear stale prompt with C-u, then health check: "who and where are you, what's up next"
