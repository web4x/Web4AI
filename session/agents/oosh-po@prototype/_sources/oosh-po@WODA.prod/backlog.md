...
- [x] **Cross-machine send/Enter — DONE (04b54a5/c3b0fa2): Escape-before-Enter dismisses autocomplete that ate Enter over SSH; live-verified remote submit works.** (cross-machine-send-submit-rename.md / otmux-send-enter-reliability.md)
