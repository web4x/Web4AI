...
**P2-follow ✓ R19.58 content-accuracy (9b32cc9b2):** stale 'current inconsistency' clause → RESOLVED note (by R20.5/R20.30/CR1); old-label refs preserved (accuracy not rename). ⚠ R19.58 is SUPERSEDED by R20.5 (7734f4e1) + filtered-from-/trace = historical-accuracy (doesn't render). Both jobs DONE → STANDBY.
