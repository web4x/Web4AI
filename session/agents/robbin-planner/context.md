...
- **REALTIME-SWITCH DEMO (Tron watching /trace, 2026-06-14):** proving the live singleton flip. Sequence BUG8→R20.14→**T94 (NOW)**→back-to-BUG8.
  ...
  - ✓ STEP 2 DONE: expert reported T94 GREEN → setChain BACK to FULL BUG8 chain (ALL 6 hops real+distinct, ZERO placeholders: 12cf7bb5/38204812/0dd08b2f/0a902bff/36934fe3/4644dd3c, Sprint 29). Singleton confirms. **DEMO COMPLETE**: BUG8→R20.14→T94→BUG8(full), live singleton flips proven for Tron. Current pin = BUG8 full chain. Standing by for next direction.
