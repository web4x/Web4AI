...
- **REALTIME-SWITCH DEMO (Tron watching /trace, 2026-06-14):** proving the live singleton flip. Sequence BUG8→R20.14→**T94 (NOW)**→back-to-BUG8.
  ...
  - ⏸ STEP 2 ARMED: on EXPERT T94 GREEN (watch pane 0.2) → setChain BACK to FULL BUG8 chain: 12cf7bb5 38204812 0dd08b2f 0a902bff 36934fe3 **4644dd3c** (real test now) "Sprint 29" "BUG8: /trace collection node detail — Loading children 404 fix" → report ok=true+pinCurrent.
