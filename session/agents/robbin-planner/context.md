...
- HONEST FLOOR = 26/204 excl 47. Docs: planner-{strict-true-floor, 21-vs-23-reconcile, r19.2-r19.8-scope-verdict, scorer-trace, climb-21-to-27, r19.8.B-recovery-r19.82-regression}-2026-06-1{3,4}.md. Tools: scripts/strict-marker-audit.ts (AST strict), scripts/trace-req.ts (per-req walkReq tiebreaker).
