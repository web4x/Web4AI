...
- ⚠ OPEN: (a) 2 DANGLING UCs (37c52953 for R27.2, f7a06e18 for R27.4) = req-side PENDING PLACEHOLDERS (architect wiring, not dead) — req to mint or drop; my tasks mirror the req refs (consistent). (b) T27.2 dedup migration + T27.4 repair = expert runs dry-run+count, I verify gates. (c) T25.7 structural-vs-display PO decision STILL pending.
