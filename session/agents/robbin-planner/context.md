...
- **Status (source-verified from committed tester verdicts, NOT relayed):** T22.1/.1.1/.1.2 = QA Review (GREEN v0.6.75 c6560f97f) · T22.2 = QA Review (GREEN v0.6.76 073378b7d) · T22.3 = QA Review (GREEN v0.6.78 adddd7ae5 + v0.6.79 data-fill) · T22.4 = In Progress (impl v0.6.78 9c052bd9a, tester RED→expert fix v0.6.79 4e3c3df0d 404→200, **testing hop OPEN — re-gate pending**). QA Review + Done LEFT for Tron gate (#9).
