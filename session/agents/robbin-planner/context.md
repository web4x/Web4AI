...
- ⚠ OPEN: (a) req to mint the PRE-EXISTING-DEBT cleanup req (12 dangling UC refs + 51 orphan Methods, measured by verify_r27_2_migration.py — NOT from dedup) → I stand up that task scenario-first. (b) UC 37c52953 (R27.2.useCases) DANGLING = likely 1 of the 12. (c) T25.7 structural-vs-display PO decision still pending.
