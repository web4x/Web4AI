...
- **BUG13 QUEUED (after R20.19, NOT active — WIP=1):** req f420e98a, task 10545051 (planned), commit 24adc0256. .url click→drawer opens; tester writes RED when WIP flips to it. When R20.19 delivers → `focus 10545051` to flip pin to BUG13.
