...
- **★ TRUE STRICT FLOOR = 23 champagne / 205 excl 46 — SM CO-SEALED 2026-06-14 (det-2x identical, triangulated w/ 59-split full-scan + PO spot-checks; reported to Tron, corrects suspect-178).** 158 of 181 canonical-credited FAIL strict. Buckets: no-named-member 93 (70 top-of-file R19.63 header-blocks like FileApi.ts:1-5/rb-detail-view.ts:1-2 + 23 deeper) · split-for 35 · mislabeled 20 · heads-const 7 · css 1 · fake 2.
