...
- ⚠ OPEN: (a) 2 DANGLING UCs (37c52953 R27.2, f7a06e18 R27.4) = req PENDING PLACEHOLDERS (architect wiring) — mirror the req refs, consistent. (b) R27.2 recurrence-guard (mint-path reuse + CI check) not yet built. (c) T25.7 structural-vs-display PO decision STILL pending.
